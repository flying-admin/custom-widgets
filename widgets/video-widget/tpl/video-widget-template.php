      ...
      <div class="fp_video__content">
        ...
        <div class="row  <?php if( $extra_content_position == 'right' ): echo 'flex-row-reverse'; endif; ?> " >
          ...
          <div class=" col-sm-12 <?php if( $extra_content == 'image' || $extra_content == 'video' ){ echo ' col-lg-6 '; }else{ echo ' col-lg-8 ' ;}?> ">
            <?php if($rich_text != ''): ?>
            <div class="fp_video__content__module">
              <?php echo $rich_text; ?>
            </div>
            <?php endif; ?>
            <?php if($link): ?>
              <a href="<?php echo $link_url; ?>" class="link link--primary link--external fp_video__content__cta" <?php if($link_blank): ?> target="_blank" <?php endif; ?>>
                <?php echo $link_text; ?>
                <?php echo siteorigin_widget_get_icon( 'genericons-external' ); ?>
              </a>
            <?php endif; ?>
