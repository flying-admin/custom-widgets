...
<?php if( $extra_content == 'video' ): ?>
  <!-- MODAL -->
  <div class="modal modal--ghost modal--wysiwyg fade" id="introduccion__modal-video-<?php echo $video_code ?>" tabindex="-1" role="dialog" aria-labelledby="modal-video-label">
