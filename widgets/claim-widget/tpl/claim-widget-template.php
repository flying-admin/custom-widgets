  ...
  <?php if($bg_type == 'video'): ?>
    <div class="fp_claim__video">
      <?php if( $video_type == 'youtube' ): ?>
        <iframe class="fp_claim__video__iframe youtube" src="https://www.youtube.com/embed/<?php echo $video_code; ?>?showinfo=0&amp;controls=0&amp;autohide=1&amp;modestbranding=1&amp;iv_load_policy=3&amp;rel=0&amp;autoplay=1&amp;loop=1&amp;mute=1&amp;playlist=<?php echo $video_code; ?>" allow="autoplay"></iframe>
      <?php endif; ?>
  ...
  <div class="fp_claim__content">
    <div class="fp_claim__content--inner">
      ...
      <?php if($cta_text != '' && $cta_url != ''): ?>
        <a href="<?php echo sow_esc_url($cta_url); ?>" class="btn btn--ghost fp_claim__content__cta" <?php if($new_window): ?> target="_blank" <?php endif; ?>>
